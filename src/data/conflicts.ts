...
export const conflicts: Conflict[] = [
...

  {
    ...
    musicTracks: [
      {
        title: "Rock Savannakhet",
        artist: "Dao Bandon",
        note: "Pre-1975 Lao popular music of the kind nearly erased after the Pathet Lao takeover; Dao Bandon's Vientiane-era recordings anchor diaspora retrospectives of the Secret War years.",
      },
      {
...

  {
    ...
    musicTracks: [
      ...
      },
      {
        ...
        artist: "Johann Pachelbel (arr. Mike Oldfield)",
        note: "Mike Oldfield's adaptation underscores the most harrowing sequences of Roland Joffé's The Killing Fields (1984), the canonical Western film about the war's collapse and its aftermath.",
      },
    ],
  },
...

  {
    ...
    musicTracks: [
      ...
      },
      {
        ...
        year: 1990,
        note: "A signature track of the Luanda-born singer who left Angola during the war, widely used in documentary treatments of the country's exile generation.",
        youtubeId: "Kl8mLhXyGis",
      },
      {
        title: "Angola",
        artist: "Teta Lando",
        note: "The patriotic anthem of one of Angola's most popular wartime singers, broadcast on state radio across MPLA-held territory throughout the conflict.",
      },
    ],
  },
    ...
    musicTracks: [
      {
        title: "Aytehazenley",
        artist: "Yemane Barya",
        note: "A signature ballad of the singer whose Tigrinya-language repertoire became central to Eritrean nationalist consciousness during the long war for independence.",
      },
      {
        title: "Semaetat",
        artist: "Abraham Afewerki",
        note: "An EPLF-era anthem honoring fallen fighters, performed at Eritrean independence-day events and woven through documentaries about the field hospitals and trenches of Sahel.",
      },
    ],
  },
