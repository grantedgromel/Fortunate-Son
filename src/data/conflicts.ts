...

  {
    ...
    musicTracks: [
      ...
      },
      {
        ...
        year: 2015,
        note: "Theme song of Netflix's Narcos, whose early seasons dramatize Pablo Escobar and the Medellín cartel; Amarante's brooding bolero has become global shorthand for the cocaine-war era.",
...

  {
    ...
    musicTracks: [
      ...
      },
      {
        ...
        youtubeId: "PNOKIkzcnzk",
      },
      {
        title: "Tuyo",
        artist: "Rodrigo Amarante",
        year: 2015,
        note: "Written as the theme for Netflix's Narcos and carried into the Narcos: Mexico spin-off; the bolero has become the cartel era's pop-culture signature.",
        youtubeId: "zNPXnAVyAUA",
      },
    ],
  },
...

  {
    ...
    musicTracks: [
      ...
      },
      {
        ...
        note: "A library-music instrumental by the Italian jazz composer that became attached to the Bosnian War through a widely shared YouTube video known as \"Black Cauldron\" — a clear case of online montage retrofitting an old recording onto a conflict.",
        youtubeId: "Y4Zs52LMLeA",
      },
    ],
  },
