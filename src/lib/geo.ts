// Maps the numeric country ids used by world-atlas topojson features to
// ISO 3166-1 alpha-3 codes, so a conflict's `countries` array can be matched
// against rendered map geographies for the footprint highlight.
export const NUM_TO_A3: Record<string, string> = {
  "004": "AFG", "008": "ALB", "012": "DZA", "024": "AGO", "031": "AZE",
  "032": "ARG", "036": "AUS", "040": "AUT", "050": "BGD", "051": "ARM",
  "056": "BEL", "068": "BOL", "070": "BIH", "076": "BRA", "100": "BGR",
  ...
  "231": "ETH", "232": "ERI", "233": "EST", "238": "FLK", "242": "FJI",
  "246": "FIN", "250": "FRA", "260": "ATF", "266": "GAB", "268": "GEO",
  ...
  "524": "NPL", "528": "NLD", "540": "NCL", "554": "NZL", "558": "NIC",
  ...
  "728": "SSD", "729": "SDN", "748": "SWZ", "752": "SWE", "756": "CHE",
  ...
  "882": "WSM", "887": "YEM", "894": "ZMB", "983": "KSV",
};

/** Resolve a world-atlas topojson feature id to its ISO-A3 code. */
export function isoOf(geoId: string | number | undefined | null): string | null {
  if (geoId == null) return null;
  return NUM_TO_A3[String(geoId).padStart(3, "0")] ?? null;
}
