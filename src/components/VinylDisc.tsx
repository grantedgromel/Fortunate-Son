...
// SVG vinyl-record marker. Concentric shockwave rings ripple outward from
// under the disc — faster and more urgent the heavier the conflict's toll.
// The grooves + label spin as one group when focused.
